...
# ── 出力先 ────────────────────────────────────────────────────────────────────
_SS_DIR = pathlib.Path(__file__).parent.parent.parent / "test" / "ss" / "timing"
...
class TimingCase:
    ...
    def filename(self) -> str:
        ...
        return f"{self.seq:02d}_{self.mnemonic}_{ts}.png"

    @property
    def title(self) -> str:
        return (
            f"{self.seq:02d} {self.mnemonic.upper().replace('_', ' ')}  "
