# 54. SIMH — PDP-11 シミュレータ <a class="qr-link" href="docs/54-simh-使い方-QR.png">QR</a>
...
- [41-cc-コンパイル-バグ調査.md](41-cc-コンパイル-バグ調査.md) — WASM 版 cc バグの詳細
- [53-参考資料.md](53-参考資料.md) — SIMH 公式サイトリンク
