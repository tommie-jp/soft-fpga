...
#endif
            VL_FATAL_MT("/work/scripts/../examples/06-8080/verilog/cpm_top.v", 21, "", "DIDNOTCONVERGE: Settle region did not converge after '--converge-limit' of 10000 tries");
        }
        __VstlIterCount = ((IData)(1U) + __VstlIterCount);
        vlSelfRef.__VstlPhaseResult = Vcpm_top___024root___eval_phase__stl(vlSelf);
        vlSelfRef.__VstlFirstIteration = 0U;
    } while (vlSelfRef.__VstlPhaseResult);
}

VL_ATTR_COLD void Vcpm_top___024root___eval_triggers_vec__stl(Vcpm_top___024root* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vcpm_top___024root___eval_triggers_vec__stl\n"); );
    Vcpm_top__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
...
VL_ATTR_COLD bool Vcpm_top___024root___eval_phase__stl(Vcpm_top___024root* vlSelf) {
    ...
    // Body
    Vcpm_top___024root___eval_triggers_vec__stl(vlSelf);
#ifdef VL_DEBUG
...
VL_ATTR_COLD void Vcpm_top___024root___ctor_var_reset(Vcpm_top___024root* vlSelf) {
    ...
    vlSelf->__Vtrigprevexpr___TOP__cpm_top__cpu____PVT__reset__0 = 0;
    for (int __Vi0 = 0; __Vi0 < 1; ++__Vi0) {
