...
ROOT="$SCRIPT_DIR/.."
EXAMPLE="$ROOT/examples/02-traffic-fsm"
...
echo "=== Verilator ==="
verilator --cc "$EXAMPLE/verilog/traffic_fsm.v" \
    --Mdir "$OBJ_DIR"
...
em++ $COMMON_FLAGS \
    ...
    -s EXPORTED_FUNCTIONS='["_sim_init","_step","_reset_sim","_press_btn","_get_ring_ptr","_get_head","_get_ring_size"]' \
