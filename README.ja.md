...
![soft-FPGA — RTL 波形のリアルタイム可視化（01-counter）](docs/img/ss/01-counter-demo.gif)

*Verilog 二進カウンタの波形をブラウザで実行 — 8 本のレジスタビットを毎クロックサンプリングし 60Hz で描画。[ライブで試す ▶](https://tommie-jp.github.io/soft-fpga/01-counter/)*
